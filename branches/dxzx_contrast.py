...
# train_data = pd.read_csv("dataset/dxzx_ms2score_train.csv")
# test_data = pd.read_csv("dataset/dxzx_ms2score_test.csv")
# train_data = pd.read_csv("dataset/dxzx_oplsda_train.csv")
# test_data = pd.read_csv("dataset/dxzx_oplsda_test.csv")
# train_data = pd.read_csv("dataset/dxzx_anova_train.csv")
# test_data = pd.read_csv("dataset/dxzx_anova_test.csv")
train_data = pd.read_csv("dataset/dxzx_train.csv")
test_data = pd.read_csv("dataset/dxzx_test.csv")

def r2_score(y_true, y_pred):
        # Calculate the mean of the true values
        y_true_mean = np.mean(y_true)
        # Calculate the numerator: sum of squares of the difference between the predicted value and the true value
        ss_res = np.sum((y_true - y_pred) ** 2)
        # Calculate the denominator: the sum of squares of the difference between the true value and the average of the true value
...
def random_forest_regression():
    ...
    # Extract Numpy format from pandas format
...
def support_vector_regression():
    ...
    svr_rbf = SVR(kernel='rbf', C=100, gamma=0.3, epsilon=0.5)
